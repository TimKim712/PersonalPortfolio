  ...
  experiences: Experience[] = [
    {
      ...
      description: [
        "Contributing to a secure data archival platform for classified and unclassified experimental test data",
        "Collaborating with senior developers to enhance user interface, improve API development, and optimize backend document processing",
      ],
